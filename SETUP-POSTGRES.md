...
> This branch (`enhancement/case-workflow`) exposes the full case surface — applicants, cases,
> decisions, documents, the dashboard, and reports. If you are deploying `master` (applicants +
> reports only), see the copy of this file there; the database steps are identical.
